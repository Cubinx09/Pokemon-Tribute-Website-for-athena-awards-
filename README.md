...
The overall layout is inspired by how the actual boxes look like in the games, a sidebar showcase the current pokemon you're looking at (although i just made that a side menu in my website) and all of the main content taking up the remainder of the screen (which in the games is just the boxed pokemon that you have). The radial blue that you see can also be seen in the gen 6 PC background. As for the start screen, its supposed to look like a turned off computer, and pressing the "power on" button...turns the PC on.
